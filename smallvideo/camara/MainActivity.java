package com.edgelesschat.smallvideo.camara;
...
import com.edgelesschat.smallvideo.camara.MediaRecorderNative;
import com.edgelesschat.smallvideo.camara.VCamera;
import com.edgelesschat.smallvideo.camara.MediaObject;
import com.edgelesschat.smallvideo.camara.UtilityAdapter;
import com.edgelesschat.smallvideo.camara.FocusSurfaceView;
import java.io.File;
...
public class MainActivity extends BaseActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mMediaObject=new MediaObject(String.valueOf(System.currentTimeMillis()), VCamera.getVideoCachePath());
...
//        String output = MyApplication.VIDEO_PATH+"/finish.mp4";
        ...
        String output = new File(Environment.getExternalStorageDirectory(),
        		tempFile.getAbsolutePath()+".mp4").getAbsolutePath();
        sb.append(" "+output);
