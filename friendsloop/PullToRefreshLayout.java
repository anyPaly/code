...
public class PullToRefreshLayout extends FrameLayout {
    ...
    private void ensureTarget(){
        if (mTarget==null){
            ...
            //调整图片大小
            ViewGroup.LayoutParams p = new ViewGroup.LayoutParams(Math.round(70*d/2),Math.round(70*d/2));
            loadingView.setLayoutParams(p);
            loadingView.setX(20*d);
            loadingView.setY(-20*d);
            loadingView.setImageResource(R.drawable.friendsloop_pulltorefres_loading);
